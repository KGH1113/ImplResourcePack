...
let mainBundleId = argValue(.mainBundleId) ?? "io.github.kgh1113.impldmnote"
let mainBundlePath = argValue(.mainBundlePath)

let app = NSApplication.shared
ProcessInfo.processInfo.processName = "ImplDmNote"
